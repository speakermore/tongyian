...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'edusoho', 'user' => 'edusoho_root', 'password' => '9YHUyFL2V7c2hGPA', 'charset' => 'UTF8', 'driverOptions' => array(), 'wrapperClass' => 'Topxia\\Service\\Common\\Connection'), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f19986b4f1bfc68be03d0dc1c040e81e45572272df654b5b198c79e3c814ccce');
        return $instance;
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'tranapezksg0gkw4wgcckocw0kwsksg');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $w = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'tranapezksg0gkw4wgcckocw0kwsksg', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    {
        $this->services['session.handler.pdo.connection'] = $instance = new \PDO('mysql:host=127.0.0.1;port=3306;dbname=edusoho', 'edusoho_root', '9YHUyFL2V7c2hGPA');
    ...
    protected function getTemplating_Helper_AssetsService()
    {
        ...
        return $this->services['templating.helper.assets'] = $this->scopedServices['request']['templating.helper.assets'] = new \Symfony\Component\Templating\Helper\CoreAssetsHelper(new \Topxia\WebBundle\Twig\Asset\PathPackage($this->get('request'), '7.2.9', '%s?%s'), array());
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('tranapezksg0gkw4wgcckocw0kwsksg');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'route_white_list' => array(
                0 => '/oauth/v2/token',
                1 => '/uploader/upload_callback',
                2 => '/uploader/process_callback',
                3 => '/coin/pay/return/alipay',
                4 => '/coin/pay/notify/alipay',
                5 => '/coin/pay/notify/wxpay',
                6 => '/pay/center/pay/alipay/return',
                7 => '/pay/center/pay/wxpay/notify',
                8 => '/pay/center/pay/alipay/notify',
                9 => '/live/verify',
                10 => '/course/order/pay/alipay/notify',
                11 => '/vip/pay_notify/alipay',
                12 => '/uploadfile/upload',
                13 => '/uploadfile/cloud_convertcallback',
                14 => '/uploadfile/cloud_convertcallback2',
                15 => '/uploadfile/cloud_convertcallback3',
                16 => '/uploadfile/cloud_convertheadleadercallback',
                17 => '/disk/upload',
                18 => '/file/upload',
                19 => '/editor/upload',
                20 => '/disk/convert/callback',
                21 => '/partner/phpwind/api/notify',
                22 => '/partner/discuz/api/notify',
                23 => '/live/auth',
                24 => '/edu_cloud/sms_callback',
                25 => '/bddServer/callback',
                26 => '/pay/center/pay/llpay/return',
                27 => '/pay/center/pay/llpay/notify',
            ),
            'database_driver' => 'pdo_mysql',
            'database_host' => '127.0.0.1',
            'database_port' => 3306,
            'database_name' => 'edusoho',
            'database_user' => 'edusoho_root',
            'database_password' => '9YHUyFL2V7c2hGPA',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'zh_CN',
            'secret' => 'tranapezksg0gkw4wgcckocw0kwsksg',
            'user_partner' => 'none',
            ...
            'kernel.secret' => 'tranapezksg0gkw4wgcckocw0kwsksg',
            ...
            'twig.options' => array(
                ...
                'paths' => array(
                    'C:\\upupw_edusoho\\htdocs\\app/../web/customize' => 'customize',
                    'C:\\upupw_edusoho\\htdocs\\app/../src/Topxia/WebBundle/Resources/views' => 'topxiaweb',
                    'C:\\upupw_edusoho\\htdocs\\app/../web/themes' => 'theme',
                    'C:\\upupw_edusoho\\htdocs\\app/../' => 'root',
                ),
