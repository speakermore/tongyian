    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if ($pathinfo === '/admin/inspect') {
                return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\DefaultController::inspectAction',  '_route' => 'admin_inspect',  '_permission' =>   array (    0 => 'admin',  ),);
            }
            ...
            if ($pathinfo === '/admin/popular_courses') {
                return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\DefaultController::popularCoursesAction',  '_route' => 'admin_popular_courses',  '_permission' =>   array (    0 => 'admin',  ),);
            }
            ...
            if (0 === strpos($pathinfo, '/admin/o')) {
                ...
                if ($pathinfo === '/admin/online/count') {
                    return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\DefaultController::onlineCountAction',  '_route' => 'admin_online_count',  '_permission' =>   array (    0 => 'admin',  ),);
                }
            ...
            if ($pathinfo === '/admin/login/count') {
                return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\DefaultController::loginCountAction',  '_route' => 'admin_login_count',  '_permission' =>   array (    0 => 'admin',  ),);
            }
