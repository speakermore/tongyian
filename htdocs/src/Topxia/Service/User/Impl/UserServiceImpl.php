...
class UserServiceImpl extends BaseService implements UserService
{
    ...
    'admissionTicketNumber'  => '',
        ...
        if(empty($fields['graduationTestScores'])){
            $fields['graduationTestScores']=60;
        }

        $userProfile = $this->getProfileDao()->updateProfileByStudents($id, $fields);
